  ...
  static ThemeData get darkTheme {
    ...
    return ThemeData(
      ...
      dialogTheme: DialogThemeData(
        ...
        titleTextStyle: const TextStyle(color: darkTextPrimary, fontWeight: FontWeight.w800, fontSize: 18),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12, color: darkTextPrimary),
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      dialogTheme: DialogThemeData(
        ...
        elevation: 0,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
        titleTextStyle: const TextStyle(color: lightTextPrimary, fontWeight: FontWeight.w800, fontSize: 18),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12, color: lightTextPrimary),
