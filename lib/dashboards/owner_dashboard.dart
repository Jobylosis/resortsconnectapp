        ...
        child: TabBarView(
          ...
          children: [
            RoomsTab(
              ...
              onGoToBookings: () => _tabController.animateTo(3),
              onShowUnpaidBalances: () => _tabController.animateTo(4),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              Text(
                'Mark ${bookingsToPay.length} booking(s) as fully paid (Total: ₱${totalAmount.toStringAsFixed(0)})?',
                style: TextStyle(
                  fontSize: 15,
