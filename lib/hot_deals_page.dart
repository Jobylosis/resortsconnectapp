...
class HotDealsPage extends StatelessWidget {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Limited time deals for your next escape.',
  ...
  Widget _buildDealCard(BuildContext context, Map data, String ownerUid) {
    final List imgs = data['imageUrls'] != null
        ? (data['imageUrls'] is List
            ? data['imageUrls']
            : (data['imageUrls'] as Map).values.toList())
        : [];
                ...
                ClipRRect(
                  ...
                  child: firstImg != null
                      ...
                      : Container(
                          ...
                          child:
                              Icon(Icons.hotel, color: imperialRed, size: 40)),
                ),
                Positioned(
                  top: 16,
                  left: 16,
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_on_outlined,
                          color: imperialRed, size: 16),
                      const SizedBox(width: 4),
                      Text(data['type'] ?? 'Resort',
                          style: const TextStyle(
